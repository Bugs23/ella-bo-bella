export default [
    {
        ...
        title: "Movie Search",
        description: "Users can type in the name of a movie into the search bar and using the Movie Database (TMDB), the app retrieves and displays a list of movies and information about those movies that are relevant to that search.",
        projectImg: require("./assets/images/movie-search-app.jpg"),
    ...
    },
    {
        ...
        projectImg: require("./assets/images/meme-generator.jpg"),
    ...
    },
    {
        ...
        projectImg: require("./assets/images/notes-app.jpg"),
    ...
    },
    {
        ...
        projectImg: require("./assets/images/mock-photography-ecommerce-site.jpg"),
